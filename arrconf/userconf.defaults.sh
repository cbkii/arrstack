...
ARR_BIND_ADDRESS="${ARR_BIND_ADDRESS:-0.0.0.0}"
SONARR_BIND_ADDRESS="${SONARR_BIND_ADDRESS:-${ARR_BIND_ADDRESS}}"
RADARR_BIND_ADDRESS="${RADARR_BIND_ADDRESS:-${ARR_BIND_ADDRESS}}"
PROWLARR_BIND_ADDRESS="${PROWLARR_BIND_ADDRESS:-${ARR_BIND_ADDRESS}}"
BAZARR_BIND_ADDRESS="${BAZARR_BIND_ADDRESS:-${ARR_BIND_ADDRESS}}"
...
GLUETUN_CONTROL_LISTEN_ADDR="${GLUETUN_CONTROL_LISTEN_ADDR:-127.0.0.1}"
GLUETUN_CONTROL_BIND_HOST="${GLUETUN_CONTROL_BIND_HOST:-${LOCALHOST_ADDR}}"
GLUETUN_CONTROL_HOST="${GLUETUN_CONTROL_HOST:-${LOCALHOST_ADDR}}"
GLUETUN_HEALTH_TARGET="${GLUETUN_HEALTH_TARGET:-1.1.1.1:443}"
GLUETUN_FIREWALL_OUTBOUND_SUBNETS="${GLUETUN_FIREWALL_OUTBOUND_SUBNETS:-192.168.1.0/24}"
