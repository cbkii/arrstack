...
# Service resource envelopes (tuned for Raspberry Pi 5; override in userconf.sh as needed)
SONARR_CPU_LIMIT="${SONARR_CPU_LIMIT:-0.6}"
SONARR_MEMORY_LIMIT="${SONARR_MEMORY_LIMIT:-512M}"
SONARR_MEMORY_RESERVATION="${SONARR_MEMORY_RESERVATION:-256M}"
RADARR_CPU_LIMIT="${RADARR_CPU_LIMIT:-1.0}"
RADARR_MEMORY_LIMIT="${RADARR_MEMORY_LIMIT:-1G}"
RADARR_MEMORY_RESERVATION="${RADARR_MEMORY_RESERVATION:-512M}"
PROWLARR_CPU_LIMIT="${PROWLARR_CPU_LIMIT:-0.4}"
PROWLARR_MEMORY_LIMIT="${PROWLARR_MEMORY_LIMIT:-512M}"
PROWLARR_MEMORY_RESERVATION="${PROWLARR_MEMORY_RESERVATION:-256M}"
BAZARR_CPU_LIMIT="${BAZARR_CPU_LIMIT:-0.35}"
BAZARR_MEMORY_LIMIT="${BAZARR_MEMORY_LIMIT:-256M}"
BAZARR_MEMORY_RESERVATION="${BAZARR_MEMORY_RESERVATION:-128M}"
FLARESOLVERR_CPU_LIMIT="${FLARESOLVERR_CPU_LIMIT:-1.0}"
FLARESOLVERR_MEMORY_LIMIT="${FLARESOLVERR_MEMORY_LIMIT:-1G}"
FLARESOLVERR_MEMORY_RESERVATION="${FLARESOLVERR_MEMORY_RESERVATION:-512M}"
